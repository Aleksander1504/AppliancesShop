		 ...
		 $i=1;
		  echo '<table class="table table-striped table-bordered bootstrap-datatable datatable responsive dataTable">';
			...
			while ($rows=mysqli_fetch_assoc($result)) {
				...
				?>
	 <td>
	 <form method='post' action=''><button type='button' class="btn btn-primary btn-info" onclick="location.href='updatedolg.php?id=<?echo $rows['id_dolj'] ?>#center'"style='margin:10px auto;'>Изменить</button></form></td>
	 <?
